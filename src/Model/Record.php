...
class Record implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['setPtr'] = isset($data['setPtr']) ? $data['setPtr'] : null;
    }
    ...
    {
        return $this->container['setPtr'];
    }

    /**
     * Sets setPtr
     *
     * @param bool|null $setPtr If set to true, the server will find the matching reverse zone and create a PTR there. Existing PTR records are replaced. If no matching reverse Zone, an error is thrown. Only valid in client bodies, only valid for A and AAAA types. Not returned by the server.
     *
     * @return $this
     */
    public function setSetPtr($setPtr)
    {
        $this->container['setPtr'] = $setPtr;
